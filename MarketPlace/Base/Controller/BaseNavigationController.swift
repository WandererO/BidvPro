...
class BaseNavigationController: UINavigationController {
    ...
    override func viewDidLoad() {
        ...
        if #available(iOS 13.0, *) {
            ...
            barApp.backgroundColor = kMainBackgroundColor//导航条背景色
            //这儿可以设置shadowColor透明或设置shadowImage为透明图片去掉导航栏的黑线
            barApp.shadowColor = UIColor.clear
            barApp.largeTitleTextAttributes = [.foregroundColor:kBlackTextColor,
                                          .font : FONT_B(size: 16)]
            //标题文字颜色
            barApp.titleTextAttributes = [NSAttributedString.Key.foregroundColor:kBlackTextColor,
                                          NSAttributedString.Key.font:FONT_B(size: 16)]
            navigationBar.scrollEdgeAppearance = barApp;
            navigationBar.standardAppearance = barApp;
            navigationBar.tintColor = kBlackTextColor
        }else{
            navigationBar.titleTextAttributes = [NSAttributedString.Key.foregroundColor:UIColor.white,
                                                 NSAttributedString.Key.font:FONT_B(size: 16)]
            //设置导航栏的背景色
            navigationBar.barTintColor = kMainBackgroundColor
        ...
        setStatusBar(backgroundColor: .white)
