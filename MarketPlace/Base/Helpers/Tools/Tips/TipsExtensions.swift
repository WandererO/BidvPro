...
extension UIViewController {
    func presentToast(_ smartToastViewController: LoafViewController) {
        smartToastViewController.transDelegate = TostManager(loaf: smartToastViewController.loaf, size: smartToastViewController.preferredContentSize)
